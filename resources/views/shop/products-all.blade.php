...
@section('main-content')
    <!-- Page Title
		============================================= -->
    <section id="page-title" class="page-title-parallax page-title-dark page-title-center" style="background-image: url('demos/store/images/men/8.jpg'); background-size: cover; padding: 170px 0 100px;" data-bottom-top="background-position: 50% 200px;" data-top-bottom="background-position: 50% -200px;">
                ...
                <div class="row">
                    ...
                    <div class="form-check col-md-2 sticky-sidebar-wrap">
                        ...
                        <ul class="list-unstyled items-nav sticky-sidebar" data-container="#shop">
                            <li><a href="{{route('shop.products.index')}}" class="text-dark fw-semibold" data-filter="*">All Products</a></li>
                            <li><hr></li>
                            ...
                            <li>
                                <input class="form-check-input" type="checkbox" name="cate[]"
                                       value="{{$category->id}}" id="{{$category->id}}" {{request()->filled('cate') && in_array($category->id,request()->cate) ? 'checked' : ''}}>
                            ...
                            <li>
                                <input class="form-check-input" type="checkbox" name="sort_by"
                                       value="title" id="title" onclick="onlyOne(this)" {{request()->filled('sort_by') && ('title'==request()->sort_by) ? 'checked' : ''}}>
                            ...
                            <li>
                                <input class="form-check-input" type="checkbox" name="sort_by"
                                       value="price_asc" id="price_asc" onclick="onlyOne(this)" {{request()->filled('sort_by') && ('price_asc'==request()->sort_by) ? 'checked' : ''}}>
                            ...
                            <li>
                                <input class="form-check-input" type="checkbox" name="sort_by"
                                       value="price_desc" id="price_desc" onclick="onlyOne(this)" {{request()->filled('sort_by') && ('price_desc'==request()->sort_by) ? 'checked' : ''}}>
                        ...
                        <div class="row">
                            @foreach($products as $product)
                                <div class="col-lg-3 col-md-2 mb-2">
                                    <div class="product">
                                        <div class="product-image position-relative" style="height: 300px; width: 300px">
                                        ...
                                        <div class="product-desc">
                                            <div class="product-title">
                                                <h3>
                                                    <a class="fw-bold" href="{{route('shop.products.show', $product->id)}}">{{$product->title}}</a>
                                                </h3>
