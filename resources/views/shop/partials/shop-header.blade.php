        ...
        <div class="container-fluid">
            <div class="header-row justify-content-lg-between">
                ...
                <div id="logo" class="me-lg-0">
                    <a href="index.html" class="standard-logo" data-dark-logo="{{asset('demos/store/images/logo-dark.png')}}"><img src="{{asset('demos/store/images/logo.png')}}" alt="Canvas Logo"></a>
                    <a href="index.html" class="retina-logo" data-dark-logo="{{asset('demos/store/images/logo-dark@2x.png')}}"><img src="{{asset('demos/store/images/logo@2x.png')}}" alt="Canvas Logo"></a>
                </div><!-- #logo end -->
                ...
                <div class="header-misc">
                    ...
                    @else
                        ...
                        <div class="btn-group px-4">
                            <button type="button" style="background-color: transparent ;border:none" class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-menu" style="">
                                ...
                                <form method="POST" class="mb-0" action="{{route('logout')}}">
                                    @csrf
                                    <button  class="dropdown-item" type="submit" style="background-color: transparent ;border:none"><i class="icon-line-log-out"></i> Log out</button>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="top-cart-items">
                                <div class="top-cart-item">
                                    <div class="top-cart-item-image">
                                        <a href="#"><img src="{{asset('demos/shop/images/items/featured/5.jpg')}}" alt="Blue Shoulder Bag" /></a>
                                    </div>
                                ...
                                <div class="top-cart-item">
                                    <div class="top-cart-item-image">
                                        <a href="#" class="fw-normal"><img src="{{asset('demos/shop/images/items/featured/1.jpg')}}" alt="Leather Bag" /></a>
                                    </div>
                                    <div class="top-cart-item-desc">
                                        <div class="top-cart-item-desc-title">
                                            <a href="#" class="fw-normal">Round Neck Solid Light Blue Colour T-shirts</a>
                ...
                <nav class="primary-menu with-arrows">
                    ...
                    <ul class="not-dark menu-container">
                        <li class="menu-item"><a class="menu-link" href="{{route('shop')}}"><div>Home</div></a></li>
                        <li class="menu-item mega-menu"><a class="menu-link" href="demo-store-products.html"><div>Men</div></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <ul class="mega-menu-column sub-menu-container col-lg-3 border-start-0">
                                            <li class="card p-0 bg-transparent border-0">
                                                <img class="card-img-top" src="{{asset('demos/store/images/others/menu.jpg')}}" alt="image cap">
                        ...
                        <li class="menu-item"><a class="menu-link" href="demo-store-products.html"><div>Women</div></a></li>
                        ...
                        <li class="menu-item"><a class="menu-link" href="demo-store-contact.html"><div>Contact</div></a></li>
                        @can('View Admin')
                        <li class="menu-item"><a class="menu-link" href="{{route('admin.index')}}"><div>Admin</div></a></li>
                        @endcan
                    </ul>
