                                ...
                                <div id="addproduct-nav-pills-wizard" class="twitter-bs-wizard form-wizard-header">
                                        ...
                                        <div class="tab-pane" id="general-info">
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div >
                                                        <textarea class="form-control" style="height: 200px; width: 870px" name="description" id="product-description"></textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <ul class="pager wizard mb-0 list-inline text-end mt-3">
                                        <li class="list-inline-item">
                                            <button type="submit" class="btn btn-success">Create Product<i
