                                ...
                                <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="general-info">
                                                ...
                                                <div>
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <div class="mb-3">
                                                                <label for="permission-name" class="form-label">permission Name
                                                                    <span class="text-danger">*</span></label>
                                                                <input type="text" name="name" id="permission-name" class="form-control"
                                    ...
                                    <ul class="pager wizard mb-0 list-inline text-end mt-3">
                                        <li class="list-inline-item">
                                            <button type="submit" class="btn btn-success">Create Permission<i
